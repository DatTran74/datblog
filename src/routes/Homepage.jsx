    ...
    <div className="mt-4 flex flex-col gap-4">
      ...
      <div className="flex items-center justify-between">
        <div className=''>
          ...
          <p className='mt-8 text-md md:text-xl'>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Tenetur excepturi quo dignissimos. </p>
        </div>
        <Link to="write" className='hidden md:block relative'>
          ...
          <button className='absolute top-0 left-0 right-0 w-20 h-20 bottom-0 m-auto bg-blue-800 rounded-full flex items-center justify-center'>
